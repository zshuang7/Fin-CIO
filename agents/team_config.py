...
cio_team = Team(
    ...
    instructions=[
        ...
        "",
        "  COMPARISON OUTPUT (Level 3+): MUST include this table near the top:",
        "    ## 📋 Side-by-side Scorecard",
        "    | Angle | Ticker A | Ticker B | Winner |",
        "    |---|---|---|---|",
        "    | Valuation | (P/E, P/B, EV/EBITDA) | (...) | A/B/Tie |",
        "    | Growth | (rev/EPS trend) | (...) | A/B/Tie |",
        "    | Profitability | (margins/FCF) | (...) | A/B/Tie |",
        "    | Balance sheet | (leverage/liquidity) | (...) | A/B/Tie |",
        "    | 🏛️ Consensus vote | (🟢/🟡/🔴 + bar) | (...) | A/B/Tie |",
        "    | 📰 Media narrative | (2–3 words) | (...) | A/B/Tie |",
        "    | Key risk | (one) | (one) | A/B/Tie |",
        "",
        "  After the table, write ONLY:",
        "    - 3 bullets: why A, why B, what would change your mind (swing factor).",
        "    - Then the CIO pick: **BUY/HOLD/SELL** for each + 1-line rationale.",
        "",
