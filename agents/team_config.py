...
wall_street_agent = Agent(
    ...
    instructions=[
        ...
        "",
        "MANDATORY OUTPUT TEMPLATE (exact structure, TWO evidence sections):",
        ...
        "",
        "[Wall Street Research]  ← from bank_snippets (Goldman, JPM, Morgan Stanley, etc.)",
        "🏦 <Bank Name> (YYYY-MM-DD): \"<analyst rating, price target, or key thesis>\"",
        "🏦 <Bank Name> (YYYY-MM-DD): \"<analyst rating, price target, or key thesis>\"",
        "(If no bank snippets available, state: 'No direct Wall Street research found in this period.')",
        "",
        "[Market News Evidence]  ← from media_snippets (Bloomberg, Reuters, WSJ, CNBC, etc.)",
        "📰 <Media Outlet> (YYYY-MM-DD): \"<headline or key development>\"",
        "📰 <Media Outlet> (YYYY-MM-DD): \"<headline or key development>\"",
        "(If no media snippets available, state: 'No Tier-1 media coverage found in this period.')",
        "",
        "[Final Synthesis]",
        "- Bull case (1 line, cite strongest evidence source)",
        "- Bear case (1 line, cite strongest evidence source)",
        "- Swing factor (1 line)",
        "",
        "Hard rules:",
...
cio_team = Team(
    ...
    instructions=[
        ...
        "         🟢 Bullish: <XX>% | 🟡 Neutral: <XX>% | 🔴 Bearish: <XX>%",
        "         Market Sentiment: <Overweight / Strong Buy / Cautious / Mixed>",
        "         [Wall Street Research]  ← 🏦 bank analyst reports (Goldman, JPM, etc.)",
        "         [Market News Evidence]  ← 📰 Tier-1 media (Bloomberg, Reuters, WSJ, etc.)",
        "         [Final Synthesis]  (bull, bear, swing factor — 1 line each)",
        "       IMPORTANT: Keep [Wall Street Research] and [Market News Evidence] SEPARATE.",
