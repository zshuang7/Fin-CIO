...
wall_street_agent = Agent(
    ...
    instructions=[
        ...
        "",
        "MANDATORY OUTPUT TEMPLATE (TWO evidence sections, use tables!):",
        "",
        ...
        "Use a TABLE if 2+ bank actions (preferred):",
        "| Bank | Date | Action/Rating | Target | Key Thesis |",
        "|---|---|---|---|---|",
        "| Goldman Sachs | Feb 2026 | Buy | $1,500 | Strong GLP-1 momentum |",
        "| Deutsche Bank | Feb 2026 | Buy | $1,285 | Production moat advantage |",
        "If only 1 bank: single bullet. If none: 'No direct Wall Street research found.'",
        "",
        "**📰 Market News Evidence:**",
        "- [Date] Source: Headline (1-line significance)",
        "- [Date] Source: Headline (1-line significance)",
        "If none: 'No Tier-1 media coverage found in this period.'",
        "",
        "**Synthesis:** Bull case | Bear case | Swing factor (1 line each, keep tight)",
        "",
        "Hard rules:",
...
cio_team = Team(
    ...
    instructions=[
        ...
        "       Use the REQUIRED template with TWO separate evidence blocks:",
        "",
        "       **Consensus Vote:**",
        "       🟢 Bullish: XX% | 🟡 Neutral: XX% | 🔴 Bearish: XX%",
        "       Market Sentiment: <Overweight / Strong Buy / Cautious / Mixed>",
        "",
        "       **🏦 Wall Street Research** (analyst reports, ratings, price targets):",
        "       USE A TABLE when 2+ bank actions are available:",
        "       | Bank | Date | Action | Target | Key Thesis |",
        "       |---|---|---|---|---|",
        "       | Goldman Sachs | Feb 2026 | Buy | $320 | FSD momentum |",
        "       | Morgan Stanley | Feb 2026 | Overweight | $300 | Energy upside |",
        "       If only 1 bank: use a single bullet instead.",
        "       If no bank data: state 'No direct Wall Street research found in this period.'",
        "",
        "       **📰 Market News Evidence** (Bloomberg, Reuters, WSJ, CNBC, etc.):",
        "       - [Date] Source: Headline (1-line significance)",
        "       - [Date] Source: Headline (1-line significance)",
        "",
        "       **Synthesis:** Bull case | Bear case | Swing factor (1 line each)",
        "",
        "       IMPORTANT: Keep 🏦 Wall Street Research and 📰 Market News SEPARATE.",
        "       Do NOT mix bank analyst reports with media headlines in the same list.",
        "       Do NOT replace this with your own generic knowledge. Use real evidence.",
        "",
        ...
        "    For EACH ticker, include the consensus vote + separated evidence:",
        "    **<Ticker A>:** 🟢 Bullish XX% | 🟡 Neutral XX% | 🔴 Bearish XX%",
        "      🏦 Wall Street: [Bank] (Date): key takeaway",
        "      📰 Media: [Outlet] (Date): key headline",
        "    **<Ticker B>:** 🟢 Bullish XX% | 🟡 Neutral XX% | 🔴 Bearish XX%",
        "      🏦 Wall Street: [Bank] (Date): key takeaway",
        "      📰 Media: [Outlet] (Date): key headline",
        "",
        "    ## 🎯 CIO Verdict",
