...
cio_team = Team(
    ...
    instructions=[
        ...
        "       Buy=X  Hold=X  Sell=X",
        "       Key Thesis: [dominant broker thesis — MUST cite bank name",
        "         e.g. 'Goldman Sachs (PT $XXX): bull case driven by...'",
        "              'Morgan Stanley (PT $XXX): cautious on...'",
        "              'JPMorgan upgrades to OW citing...']",
        "       Contrarian: [most bearish/bullish outlier — cite source]",
