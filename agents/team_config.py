...
cio_team = Team(
    ...
    instructions=[
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
        "",
        "OUTPUT FORMAT (fill each section — keep total under 600 words):",
        "  ## 🧠 Query Understanding   ← 1-2 lines: what was asked + query type",
        "  ## 📊 [Relevant sections from agents — summarise, don't repeat verbatim]",
        "  ## 🎯 Recommendation        ← BUY/HOLD/SELL | Conviction | Target | Horizon",
        "  ## ⚠️  Key Risks             ← 3-5 bullets (specific, not generic)",
