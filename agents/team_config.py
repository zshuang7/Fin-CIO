...
query_analyst = Agent(
    ...
    instructions=[
        ...
        "  Asian and European markets use numeric ticker codes, NOT letters.",
        "  The format is:  <number> <exchange>  or  <number>.<exchange>",
        "  Examples:",
        "    '2015 HK'  →  2015.HK  (Li Auto Inc., Hong Kong Exchange)",
        "    '1211 HK'  →  1211.HK  (BYD Company, Hong Kong Exchange)",
        "    '0700 HK'  →  0700.HK  (Tencent, Hong Kong Exchange)",
        "    '8306 T'   →  8306.T   (Mitsubishi UFJ, Tokyo Exchange)",
        "    '7203 T'   →  7203.T   (Toyota, Tokyo Exchange)",
        "    'HSBA L'   →  HSBA.L   (HSBC, London Stock Exchange)",
        "  NEVER interpret a numeric code followed by an exchange suffix",
        "  as a year + market name.  '2015 HK' is NOT 'Hong Kong in 2015'.",
        "  The TICKER DISAMBIGUATION banner in the output will flag this.",
    ],
    markdown=True,
)
...
cio_team = Team(
    ...
    instructions=[
        ...
        "  Before writing the final answer, verify ALL four checkpoints:",
        "    1. Do macro conditions support or contradict the fundamentals?",
        "    2. Does recent news confirm or challenge the valuation thesis?",
        "    3. WALL STREET CHECK (Level 3+ STOCK_ANALYSIS only):",
        "         → What is the Street consensus? (Overweight / Neutral / Underweight)",
        "         → Avg analyst target vs. current price — upside/downside %?",
        "         → Do YOU (CIO) agree with the consensus? State WHY clearly.",
        "           If you DISAGREE: explain your contrarian thesis.",
        "           If you AGREE: name one catalyst that could flip the consensus.",
        "    4. Are there data conflicts between EODHD targets and Tavily text?",
        "       State them explicitly — do not hide them.",
        ...
        "  Level 1: 2-3 sentences only. Include 1 cited data point.",
        "  Level 2: ## Snapshot + ## Verdict  (no full section structure).",
        "  Level 3-5 (STOCK_ANALYSIS and COMPARISON) — MANDATORY SECTIONS in order:",
        "    ## 🧠 Query Understanding",
        "       1-2 lines: what was asked + query type",
        "    ## 📊 Fundamentals",
        "       From CompanyAgent: price, P/E, revenue trend, EPS, key flag",
        "    ## 🏦 Wall Street View  ← MANDATORY for STOCK_ANALYSIS/COMPARISON Level 3+",
        "       Consensus: [Overweight / Neutral / Underweight] | Avg Target: $XX",
        "       Analysts: N  |  Buy=X  Hold=X  Sell=X",
        "       Key Thesis: [dominant bull/bear narrative cited by brokers — cite bank if known]",
        "       Contrarian: [outlier analyst view — cite bank/analyst name if available]",
        "       CIO vs Street: [do you agree or disagree? WHY? be specific]",
        "    ## 🌐 Macro & Sector",
        "       From MacroAgent: 2-3 bullets on rates, growth, sector tailwinds/headwinds",
        "    ## 📰 News & Sentiment",
        "       From NewsAgent: 2-3 headlines + one-line sentiment verdict",
        "    ## 🎯 Recommendation",
        "       BUY / HOLD / SELL | Conviction: High/Med/Low | Target | Horizon",
        ...
        "  Level 3-5 MARKET/HISTORICAL: omit ## 🏦 Wall Street View (not applicable).",
