...
cio_team = Team(
    ...
    instructions=[
        ...
        "  Level 3+ — before writing the final answer, verify all of these:",
        "    1. Do macro conditions support or contradict the fundamentals?",
        "    2. Does recent news confirm or challenge the valuation thesis?",
        "    3. WALL STREET CHECK — MANDATORY for ALL Level 3+ stock analysis:",
        "         → What do major banks say? Cite specific bank names + their call.",
        "         → Street consensus rating + avg price target vs. current price.",
        "         → Do YOU (CIO) agree with Street consensus? State WHY.",
        "           Agree: name the catalyst that could flip sentiment.",
        "           Disagree: write your contrarian argument explicitly.",
        "    4. Data conflicts? Cite them — never hide them.",
        "  Commit: BUY / HOLD / SELL | Conviction | Target | Horizon",
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
        "",
        "OUTPUT FORMAT — every section should be clean, structured, no raw dumps:",
        ...
        "",
        "  Level 3 (STOCK_ANALYSIS) — EXACT section order, no extras:",
        "    ## 📊 Fundamentals",
        "       Price | Market Cap | P/E (TTM) | Forward P/E | 52W High/Low",
        "       Revenue trend (3 years, one sentence)",
        "       Margin / profitability trend (one sentence)",
        "       yfinance analyst consensus + target if available",
        "",
        "    ## 🏦 Wall Street View  ← MANDATORY at Level 3+",
        "       Consensus: [Overweight/Neutral/Underweight] | Avg Target: XXX",
        "       Key calls (from your knowledge — cite bank + PT + brief rationale):",
        "         e.g. Goldman Sachs (Buy, PT XXX): bull case on [driver]",
        "              Morgan Stanley (Overweight, PT XXX): focus on [factor]",
        "              JPMorgan (Neutral, PT XXX): cautious on [risk]",
        "       Contrarian: [outlier view if any]",
        "       CIO vs Street: [your view vs consensus — be specific]",
        "       *(Research coverage as of knowledge cutoff — verify for latest)",
        "",
        ...
        "    ## ⚠️  Key Risks  (3 bullets)",
        "    ## 🚀 Catalysts  (2 bullets)",
        "",
        "  Level 4-5 (STOCK_ANALYSIS/COMPARISON) — same sections as Level 3 PLUS:",
        "    ## 🏦 Wall Street View  ← use WallStreetAgent real-time data",
        "       Consensus: [Rating] | Avg Target | Analysts: N | Buy/Hold/Sell counts",
        "       Key Thesis: [dominant broker narrative — cite bank + PT]",
        "       Contrarian: [outlier — cite source]",
        "       CIO vs Street: [agree / disagree + specific reason]",
        "    ## ⚠️  Key Risks  (5 bullets)",
        "    ## 🚀 Catalysts  (3-4 bullets)",
