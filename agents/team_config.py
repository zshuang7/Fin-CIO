...
wall_street_agent = Agent(
    ...
    instructions=[
        ...
        "     Call: wall_street_search(symbol, 'Goldman Sachs OR Morgan Stanley OR JPMorgan OR UBS OR Citi OR BofA last 30 days')",
        "     Only accept evidence from Tier-1 entities (banks/institutions).",
        "     DO NOT use Zacks / InsiderMonkey / random blogs as 'institutional'.",
