...
cio_team = Team(
    ...
    instructions=[
        ...
        "    Output: Full sections, data tables, explicit data conflicts.",
        "",
        ...
        "    ✘ WallStreetAgent: SKIP at Level 3 (too slow for standard queries)",
        "",
        ...
        "    ✘ WallStreetAgent: SKIP at Level 3",
        "",
        ...
        "  Level 3+ — before writing the final answer, verify:",
        "    1. Do macro conditions support or contradict the fundamentals?",
        "    2. Does recent news confirm or challenge the valuation thesis?",
        "    3. WALL STREET CHECK (Level 4+ STOCK_ANALYSIS only):",
        "         → Street consensus? Avg target vs. current price → upside %?",
        "         → Do YOU agree? If DISAGREE: explain your contrarian thesis.",
        "    4. Data conflicts? State them — do not hide them.",
        "  Commit to: BUY / HOLD / SELL | Conviction | Target | Horizon",
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
        "",
        "OUTPUT FORMAT:",
        ...
        "  Level 3 (STOCK/MARKET/HISTORICAL):",
        "    ## 🧠 What was asked   (1 line)",
        "    ## 📊 Fundamentals     (price, P/E, trend — from CompanyAgent)",
        "    ## 🌐 Macro & News     (combined: 2-3 bullets each)",
        "    ## 🎯 Recommendation   (BUY/HOLD/SELL | Conviction | Target | Horizon)",
        "    ## ⚠️  Key Risks        (3 bullets)",
        "  Level 4-5 (STOCK_ANALYSIS/COMPARISON):",
        "    ## 🧠 Query Understanding",
        "    ## 📊 Fundamentals",
        "    ## 🏦 Wall Street View  ← Level 4+ ONLY",
        "       Consensus: [Rating] | Avg Target: $XX | Analysts: N",
        "       Buy=X  Hold=X  Sell=X",
        "       Key Thesis: [dominant broker narrative — cite bank if known]",
        "       Contrarian: [outlier view — cite source if available]",
        "       CIO vs Street: [agree / disagree — WHY?]",
        "    ## 🌐 Macro & Sector",
        "    ## 📰 News & Sentiment",
        "    ## 🎯 Recommendation",
